            ...
            share.setOnClickListener {
                if (intent.hasExtra("loginInformation")) {
                    if (roomName.text.toString() != "" && password.text.toString()!= "") {
                        ...
                        /*datas.child("roomnames").addValueEventListener(object : ValueEventListener {
                            override fun onDataChange(dataSnapshot: DataSnapshot) {
                                // This method is called once with the initial value and again
                                // whenever data at this location is updated.
                                val value = dataSnapshot.getValue(String::class.java)
                        ...
                        /*database.child("roomnames").orderByChild("Roomname").equalTo(roomName.text.toString()).once('value', function(data){
